...
| [openai-image-gen](skills/openai-image-gen) | 通过 OpenAI 兼容图像端点(/v1/images)文生图与图生图:支持 new-api / sub2api 等网关,自带 Node / Python / PowerShell 三份等价零依赖脚本,支持参考图、mask 局部重绘与多尺寸 | 原创 | — |
